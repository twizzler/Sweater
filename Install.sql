...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `LoginKey` char(40) DEFAULT NULL COMMENT 'Used for logging into the game server',
  ...
  `Nameglow` mediumtext NOT NULL,
  `Namecolor` mediumtext NOT NULL,
  `Text` mediumtext NOT NULL,
  `Bubblecolor` mediumtext NOT NULL,
  `Penguinglow` mediumtext NOT NULL,
  `Snowballglow` mediumtext NOT NULL,
  `Ringcolor` mediumtext NOT NULL,
  `Chatglow` mediumtext NOT NULL,
  `Moodcolor` mediumtext NOT NULL,
  `Moodglow` mediumtext NOT NULL,
